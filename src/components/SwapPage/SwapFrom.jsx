...
const SwapFrom = () => {
  return (
    <div className="border border-text rounded-lg flex items-center">
      <div className="border-r-2 border-r-text w-40 flex justify-between p-4 font-medium text-xl items-center">
