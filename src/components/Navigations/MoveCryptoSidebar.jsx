...
const ActionButton = ({ Icon, label }) => {
  return (
    <div className="flex gap-2 items-center text-text hover:bg-bgColor rounded-md transition-all duration-300 cursor-pointer p-4 bg-white w-48 sticky top-0 h-scr">
