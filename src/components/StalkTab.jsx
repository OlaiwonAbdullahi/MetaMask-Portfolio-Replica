...
const StalkTab = () => {
  ...
  const tabs = [
    ...
    { id: 3, label: "Liquid staking", content: <ReceiveTab /> },
  ];

  return (
    <div className="w-full mx-auto mt-10 bg-bgColor p-4 rounded-lg flex flex-col">
      ...
      <div className="mt-4 p-4  rounded-lg bg-bgColor">
